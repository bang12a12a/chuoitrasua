...
namespace ChuoiCuaHangTraSua.Models.Dao
{
    public class CartDao
    {
        ...
        public List<GioHang> layDSSP(int productid, int userid)
        {
            return db.GioHangs.Where(x => x.ThuocSanPham == productid && x.MaKhachHang==userid).ToList();
        }
        ...
        internal string getMoTa(int id, string v)
        {
